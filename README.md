...
[![CI](https://github.com/Gordi42/stama/actions/workflows/ci.yml/badge.svg)](https://github.com/Gordi42/stama/actions/workflows/ci.yml)
...
# Installation
## Prebuilt binaries
Download a prebuilt binary from the [GitHub releases page](https://github.com/Gordi42/stama/releases). For clusters, the `x86_64-unknown-linux-musl` build is recommended: it is a static binary that works on old login nodes without root or a Rust toolchain.
